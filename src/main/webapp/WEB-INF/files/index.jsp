...
<TABLE WIDTH=750 BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
    ...
    <TR>
        ...
        <TD width="306" height="185" background="/images/index_05.gif"><table width="250" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td><form  action="${pageContext.request.contextPath}/login.action" method=post name=login>
                    <div align="center">
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td height="30"><div align="center"><strong>用户名：</strong>
                                    <INPUT name="operatorName" type="text" value="">
                                    <br>
                                </div></td>
                            </tr>
                            <tr>
                                <td height="30"><div align="center"><strong>密&nbsp;&nbsp;&nbsp;码：</strong>
                                    <INPUT name="operatorPassword" type=password value="">
                                </div></td>
                            </tr>
                            <tr>
                                <td height="30">
