    ...
    <TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
        ...
        <TR vAlign=top>
            <TD height="600" bgColor=#f1f3f9>
                <form method="POST" action="/customer/newcustomer1.action">
                    <p>证件类型：<select size="1" name="identifyName">
                        <c:forEach items="${list}" var="identify">
                        <option value="${identify.certificateName}">${identify.certificateName}</option>
                        </c:forEach>
                    </select></p>
                    <p>证件号码：<input type="text" name="certificate" size="20"></p>
