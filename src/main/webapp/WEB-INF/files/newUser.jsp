    ...
    <TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
        ...
        <TR vAlign=top>
            <TD height="600" bgColor=#f1f3f9>
                ...
                <form method="POST" action="/customer/saveUser.action">

                    <input type = "hidden" value="${param.identifyName}" name = "identifyName">
                    <input type = "hidden" value="${param.certificate}" name = "certificateCard">
                    <input type = "hidden" value="${param.customerName}" name = "customerName">
                    <input type = "hidden" value="${param.sex}" name = "sex">
                    <input type = "hidden" value="${param.birthday}" name = "birthday">
                    <input type = "hidden" value="${param.address}" name = "address">

                    <p>手机号码：<input type="text" name="phoneNumber" size="20" id="phoneNumber"><span id="error"></span></p>
                    <p>漫游状态：<input type="radio" name="romingState" value="省内漫游" checked>省内漫游 <input type="radio" name="romingState" value="国内漫游">国内漫游
                        <input type="radio" name="romingState" value="国际漫游">国际漫游</p>
                    <p>通话级别：<input type="radio" value="本地通话" checked name="callLeave">本地通话
                        <input type="radio" name="callLeave" value="国内长途">国内长途 <input type="radio" name="callLeave" value="国际长途">国际长途</p>
